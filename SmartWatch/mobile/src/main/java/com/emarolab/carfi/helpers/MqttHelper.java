...
public class MqttHelper {
    ...
    private boolean publishNNPermission = false;
        ...
        try {
            ...
            mqttAndroidClient.connect(mqttConnectOptions, null, new IMqttActionListener() {
                ...
                public void onSuccess(IMqttToken asyncActionToken) {
                    ...
                    setPublishPermission(false);
                    setPublishNNPermission(true);
                }
    ...
    public void onDataReceived(String topic, String msg) {
        if(publishNNPermission) {
            Publisher.setTopicAndMsg(topic, msg);
        }
    }
    ...
    public void setPublishNNPermission(boolean flag){
        publishNNPermission = flag;
    }
